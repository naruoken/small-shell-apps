...
# gen %%tag contents
$META get.tag:announcements{$databox} > ../tmp/$session/tags
...
../bin/announcements_page_links.sh $page $pages "$table_command" $num_of_line_per_page > ../tmp/$session/page_link &
wait
