...
DATA_SHELL="sudo -u small-shell ${small_shell_path}/bin/DATA_shell session:$session pin:$pin app:bookmarks"
...
# render HTML
cat ../descriptor/bookmarks_log_viewer.html.def | sed "s/^ *</</g" \
